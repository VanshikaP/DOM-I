...
document.querySelector('.start-button').addEventListener('click', function (){
  ...
  document.querySelector('.stop-button').style.background = 'teal';
  document.querySelector('.reset-button').style.background = 'teal';
  ...
  function milliseconds(){
    if(secondOnes.textContent == 0 && secondTens.textContent == 1){
      msHundreds.textContent = 0;
      msTens.textContent = 0;
      document.querySelector('.start-button').style.background = 'teal';
